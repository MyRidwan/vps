...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/myridwan/vps/ipuk/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://raw.githubusercontent.com/myridwan/vps/ipuk/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://raw.githubusercontent.com/myridwan/vps/ipuk/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/myridwan/vps/ipuk/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/myridwan/vps/ipuk/check-pptp.sh && chmod +x /usr/bin/check-pptp
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/myridwan/vps/ipuk/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/myridwan/vps/ipuk/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
