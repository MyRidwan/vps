...
#install v2ray
wget http://raw.githubusercontent.com/myridwan/vps/ipuk/ins-vt.sh && chmod +x ins-vt.sh && ./ins-vt.sh
#install L2TP
...
echo "   - Websocket OpenSSH       : 80, 2082, 8880"  | tee -a log-install.txt
echo "   - OpenVPN                 : TCP 1194, UDP 2200, SSL 442"  | tee -a log-install.txt
echo "   - Stunnel4                : 442, 777"  | tee -a log-install.txt
...
echo "   - V2RAY Vless None TLS    : 2091"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : Ridwan Freecs"  | tee -a log-install.txt
