...
echo "Silahkan Hubungi Admin RIDWAN STORE"
exit 0
fi
clear
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : Ridwan - Store"  | tee -a log-install.txt
echo "   - Telegram                : T.me/rifan_aje"  | tee -a log-install.txt
echo "   - Whatsapp                : 085781385825"  | tee -a log-install.txt
echo "------------------Script Created By RidwanVpn-----------------" | tee -a log-install.txt
echo "©===========Sc By RidwanVpn==========©" | tee -a log-install.txt
echo ""
rm -f setup.sh