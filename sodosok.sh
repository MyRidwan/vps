...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/myridwan/vps/ipuk/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/myridwan/vps/ipuk/del-ss.sh"
wget -O check-ss "https://raw.githubusercontent.com/myridwan/vps/ipuk/check-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/myridwan/vps/ipuk/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x check-ss
chmod +x renew-ss
