...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/myridwan/vps/ipuk/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/myridwan/vps/ipuk/del-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/myridwan/vps/ipuk/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x check-wg
chmod +x renew-wg
